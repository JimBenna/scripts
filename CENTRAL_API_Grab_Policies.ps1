...
$OutputFile = "Policies_list_$ScriptLaunchDate.json"
# SOPHOS OAuth URL
...
$NextKey = $null
    # Invoke Request
    do {
        $GetPolicies = (Invoke-RestMethod -Method Get -Uri $DataRegion"/endpoint/v1/policies?pageTotal=true&pageFromKey=$NextKey" -Headers $TenantHead -ErrorAction SilentlyContinue -ErrorVariable ScriptError)
